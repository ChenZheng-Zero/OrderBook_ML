...
def extract_features_from_order_books(limit_order_filename, feature_filename, n_level, delta_t=50, delta_T=0):
    if not os.path.isfile(feature_filename):
        basic_set, timestamps, basic_labels = \
            extract_basic_features(limit_order_filename, n_level)
        ...
        return timestamps, basic_set, time_insensitive_set, basic_labels


def extract_basic_features(limit_order_filename, n_level):
